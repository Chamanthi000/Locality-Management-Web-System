...
<form class="form" method="post" action="localproblems2.php">
...
<div class="row part">
        <div class="col-lg-8">
            <input type="text" name="pid"  placeholder="Enter your Problem ID" class="filler">
        </div>
...
<div class="row part">
    <div class="col-lg-8">
        <input type="text" name="pname" required placeholder="Enter your Problem Name" class="filler">
    </div>
</div>   
<div class="row">
