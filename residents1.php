...
<form class="form" method="post" action="residents2.php">
...
<div class="row part">
        <div class="col-lg-8">
            <input type="text" name="residence"  placeholder="Enter your Residence Name" class="filler">
        </div>
...
<div class="row part">
    <div class="col-lg-8">
        <input type="text" name="dno" required placeholder="Enter your Door No" class="filler">
    </div>
</div>   
<div class="row">
