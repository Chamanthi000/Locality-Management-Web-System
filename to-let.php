...
<div class="post">
  ...
  <form class="form" method="post" action="to-let2.php" mthod="post">
  ...
  <div class="row">
      ...
      <div class="row">
          ...
          <div class="row">
              ...
              <div class="row part">
                  <div class="col-lg-8">
                      <input type="text" name="rent"placeholder="individual/flat" class="filler">
                  </div>
                </div>
          ...
          <div class="row part">
              <div class="col-lg-8">
                  <input type="text" name="type" placeholder=" Enter rent to be paid" class="filler">
              </div>
          </div>
